...
date: 2023-07-20
authors: [EJ]
title: (샘플 글입니다) MORAI SIM의 학습 데이터셋 생성 기술 
description: >
...
# [제목] MORAI SIM의 학습 데이터셋 생성 기술
**(요약 내용 작성하기: 제목 하단의 설명 문구를 자세히 풀어쓰세요.)**
...
## [서론] 들어가며
**(주제 소개: 주제에 해당하는 기술 배경과 소개를 작성하세요)**
...
## [본론 1] MORAI SIM의 데이터셋 생성 기술 특징
**(주요 내용: 소개한 제품 및 기능의 구조, 동작 방식, 특장점, 사용 예제 등 주제와 관련한 주요 내용을 단락 별로 작성하세요.)**
...
![23-07-20/그림2.png](23-07-20/그림2.png)
<figcaption><b><center>그림 2. MORAI SIM 카메라 센서에서 검출한 Semantic Segmentation 이미지 및 2D BBox</center></b></figcaption>

![23-07-20/그림3.png](23-07-20/그림3.png)
...
### [본론 1.2] 다양한 주행 환경을 반영한 학습 데이터셋 생성 
...
MORAI SIM은 이러한 시나리오 환경 구성 및 센서 설정 정보를 바탕으로 시뮬레이션 기본 동작 속도인 '60 FPS'에 맞추어 매 스텝마다 데이터를 생성할 수 있습니다. 
...
## [본론 3] MORAI DataGen과 연동한 대규모 데이터셋 구축 
**{주요 내용: 소개한 제품 및 기능의 구조, 동작 방식, 특/장점, 사용 예제 등 주제와 관련한 주요 내용을 단락 별로 작성하세요.}**
...
## [결론] 마치며
**맺음말: 본론에서 설명한 주요 내용을 요약하고 강조하세요.**
